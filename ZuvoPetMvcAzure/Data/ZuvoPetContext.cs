...
namespace ZuvoPetMvcAzure.Data
{
    public class ZuvoPetMvcAzureContext: DbContext
    {
        public ZuvoPetMvcAzureContext(DbContextOptions<ZuvoPetMvcAzureContext> options): base(options){}
